(function(){
  ...
  function addStyles(){
    ...
    s.textContent=`
      ...
      @media(max-width:900px){.rk-search-v5-stat{min-width:0;padding:0 18px}.rk-search-v5-popular{grid-template-columns:repeat(2,1fr)}.rk-search-v5-quick{grid-template-columns:repeat(4,1fr)}}
      @media(max-width:720px){
        .rk-search-v5-nav{display:none!important}.rk-search-v5 #rk-topbar>div{padding:11px 14px!important}.rk-search-v5-hero{min-height:auto!important;padding:50px 16px 40px!important}.rk-search-v5-logo{margin-bottom:16px!important}.rk-search-v5-logo>span:first-child{width:48px!important;height:48px!important}.rk-search-v5-sub{font-size:14px;margin-bottom:23px}
        .rk-search-v5 #rk-herosearch{border-radius:22px!important;flex-direction:row!important}.rk-search-v5 #rk-herosearch input{height:68px!important;font-size:16px!important;padding:17px 10px 17px 52px!important}.rk-search-v5 #rk-herosearch>div>svg{left:19px!important;width:22px!important;height:22px!important}.rk-search-v5 #rk-herosearch button{width:54px!important;min-width:54px!important;height:54px!important;margin:7px 7px 7px 0!important}.rk-search-v5 #rk-herosearch button svg{width:21px!important;height:21px!important}
        .rk-search-v5-chips{justify-content:flex-start;width:100%}.rk-search-v5-chips-label{width:100%;text-align:left}.rk-search-v5-stats{display:grid;grid-template-columns:1fr 1fr;width:100%;gap:20px;margin-top:30px}.rk-search-v5-stat{border:0!important;padding:0!important}.rk-search-v5-quick{grid-template-columns:repeat(4,1fr);margin-top:28px;padding-top:0}.rk-search-v5-scroll{display:none}.rk-search-v5-below{padding:50px 16px 64px}.rk-search-v5-section{padding-bottom:50px}.rk-search-v5-section h2{font-size:25px}.rk-search-v5-popular,.rk-search-v5-catalog{grid-template-columns:1fr}
      }
      @media(max-width:480px){.rk-search-v5-chip:nth-of-type(n+5){display:none}.rk-search-v5-quick{grid-template-columns:repeat(3,1fr)}.rk-search-v5-quick>*:nth-child(n+7){display:none}}
    `;
    document.head.appendChild(s);
  }

  function createChips(){
    var d=document.createElement('div');d.className='rk-search-v5-chips';
    d.innerHTML='<span class="rk-search-v5-chips-label">Популярные запросы:</span><button class="rk-search-v5-chip" data-rk-query="Договор аренды">Договор аренды</button><button class="rk-search-v5-chip" data-rk-query="Калькулятор НДС">Калькулятор НДС</button><button class="rk-search-v5-chip" data-rk-query="Счёт на оплату">Счёт на оплату</button><button class="rk-search-v5-chip" data-rk-query="Бизнес-план">Бизнес-план</button><button class="rk-search-v5-chip" data-rk-query="Акт выполненных работ">Акт выполненных работ</button>';
    return d;
  }

  function createStats(){
    var d=document.createElement('div');d.className='rk-search-v5-stats';
    d.innerHTML='<div class="rk-search-v5-stat"><b><em>200 000+</em></b>шаблонов и вариантов</div><div class="rk-search-v5-stat"><b><em>276</em></b>калькуляторов</div><div class="rk-search-v5-stat"><b><em>468</em></b>сервисов</div><div class="rk-search-v5-stat"><b>Бесплатно</b>для бизнеса</div>';
    return d;
  }

  function createQuick(){
    var d=document.createElement('div');d.className='rk-search-v5-quick';
    d.innerHTML='<a href="./dokumenty.html">'+icon('doc')+'<span>Документы</span></a><a href="./kalkulyatory.html">'+icon('calc')+'<span>Калькуляторы</span></a><a href="./servisy.html">'+icon('cube')+'<span>Сервисы</span></a><a href="./#tab=taxes">'+icon('tax')+'<span>Налоги 2026</span></a><button data-rk-query="Финансы">'+icon('money')+'<span>Финансы</span></button><button data-rk-query="Продажи">'+icon('sales')+'<span>Продажи</span></button><button data-rk-query="Кадры">'+icon('hr')+'<span>Кадры</span></button>';
    return d;
  }

  function createBelow(){
    var wrap=document.createElement('div');wrap.id='rk-search-v5-below';wrap.className='rk-search-v5-below';
    wrap.innerHTML='<section class="rk-search-v5-section" id="rk-v5-popular"><div class="rk-search-v5-section-head"><h2>Популярные инструменты</h2><a href="./servisy.html">Все инструменты →</a></div><div class="rk-search-v5-popular"><button class="rk-search-v5-tool" data-rk-query="Договор оказания услуг"><strong>→</strong><b>Договор оказания услуг</b><span>Найти готовый документ</span></button><button class="rk-search-v5-tool" data-rk-query="Счёт на оплату"><strong>→</strong><b>Счёт на оплату</b><span>Создать онлайн</span></button><button class="rk-search-v5-tool" data-rk-query="Калькулятор НДС"><strong>→</strong><b>Калькулятор НДС</b><span>Расчёт по ставкам 2026</span></button><button class="rk-search-v5-tool" data-rk-query="Стоимость сотрудника"><strong>→</strong><b>Стоимость сотрудника</b><span>Полная нагрузка работодателя</span></button><button class="rk-search-v5-tool" data-rk-query="Бизнес-план"><strong>→</strong><b>Бизнес-план</b><span>Шаблоны и инструменты</span></button><button class="rk-search-v5-tool" data-rk-query="Проверка контрагента"><strong>→</strong><b>Проверка контрагента</b><span>Инструменты для бизнеса</span></button></div></section><section class="rk-search-v5-section"><div class="rk-search-v5-section-head"><h2>Всё для бизнеса</h2></div><div class="rk-search-v5-catalog"><a class="rk-search-v5-category" href="./dokumenty.html"><span class="rk-search-v5-category-icon">'+icon('doc')+'</span><div><b>Документы</b><span>200 000+ шаблонов и отраслевых вариантов: договоры, акты, счета, заявления и другое.</span></div><i>→</i></a><a class="rk-search-v5-category" href="./kalkulyatory.html"><span class="rk-search-v5-category-icon">'+icon('calc')+'</span><div><b>Калькуляторы</b><span>276 бизнес-калькуляторов в 21 направлении.</span></div><i>→</i></a><a class="rk-search-v5-category" href="./servisy.html"><span class="rk-search-v5-category-icon">'+icon('cube')+'</span><div><b>Сервисы</b><span>468 рабочих сервисов в 28 направлениях.</span></div><i>→</i></a><a class="rk-search-v5-category" href="./#tab=taxes"><span class="rk-search-v5-category-icon">'+icon('tax')+'</span><div><b>Налоги 2026</b><span>УСН, НДС, патент, НПД, АУСН, НДФЛ, взносы ИП, ЕНС и пени.</span></div><i>→</i></a></div></section>';
    return wrap;
  }

  function ensureNav(topbar){
    var inner=topbar.firstElementChild;if(!inner) return;
    Array.prototype.forEach.call(inner.querySelectorAll('.rk-v2-nav,.rk-search-nav,.rk-search-v3-nav,.rk-search-v4-nav,.rk-search-v5-nav'),function(n){n.remove();});
    var nav=document.createElement('nav');nav.className='rk-search-v5-nav';
  ...
  function findResults(hero,tools){
    ...
    while(node&&node!==tools){var h=node.querySelector&&node.querySelector('h2');if(h&&h.textContent.indexOf('Результаты поиска')!==-1) return node;node=node.nextElementSibling;}
    return null;
  }
  ...
  function ensureHero(search,tools){
    var hero=search.parentElement;if(!hero) return;
    hero.classList.remove('rk-home-hero','rk-search-hero','rk-search-v3-hero','rk-search-v4-hero');hero.classList.add('rk-search-v5-hero');cleanLegacy(hero);
    var first=hero.firstElementChild;
    if(first&&first!==hero.querySelector('h1')&&first.id!=='rk-herosearch'){first.classList.remove('rk-v2-hide','rk-search-logo','rk-search-v3-logo','rk-search-v4-logo');first.classList.add('rk-search-v5-logo');first.style.display='flex';}
    var h1=hero.querySelector('h1');if(h1) h1.textContent='Найдётся любой инструмент для вашего бизнеса';
    var sub=hero.querySelector('.rk-search-v5-sub');if(!sub){sub=document.createElement('div');sub.className='rk-search-v5-sub';sub.textContent='Документы, калькуляторы, сервисы, шаблоны и инструкции — всё в одном месте.';hero.insertBefore(sub,search);}
    var input=document.getElementById('rk-herosearch-input');if(input) input.placeholder='Например: договор аренды, калькулятор НДС, счёт на оплату...';
    var button=search.querySelector('button');if(button&&!button.querySelector('svg')) button.innerHTML='<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle cx="11" cy="11" r="6.7"/><path d="m16 16 4.3 4.3"/></svg><span style="position:absolute;width:1px;height:1px;overflow:hidden">Найти</span>';
    var original=search.nextElementSibling;if(original&&!original.classList.contains('rk-search-v5-chips')){original.style.display='none';var originalNote=original.nextElementSibling;if(originalNote&&!originalNote.classList.contains('rk-search-v5-chips')) originalNote.style.display='none';}
    var chips=hero.querySelector('.rk-search-v5-chips');if(!chips){chips=createChips();search.insertAdjacentElement('afterend',chips);}
    var results=findResults(hero,tools);if(results){results.classList.add('rk-search-v5-results');if(results.parentElement!==hero||results.previousElementSibling!==chips) chips.insertAdjacentElement('afterend',results);}
    document.body.classList.toggle('rk-search-v5-has-results',!!results);
    var stats=hero.querySelector('.rk-search-v5-stats');if(!stats){stats=createStats();(results||chips).insertAdjacentElement('afterend',stats);}else if(results&&stats.previousElementSibling!==results) results.insertAdjacentElement('afterend',stats);
    var quick=hero.querySelector('.rk-search-v5-quick');if(!quick){quick=createQuick();stats.insertAdjacentElement('afterend',quick);}
    var scroll=hero.querySelector('.rk-search-v5-scroll');if(!scroll){scroll=document.createElement('div');scroll.className='rk-search-v5-scroll';scroll.textContent='Прокрутите, чтобы узнать больше';quick.insertAdjacentElement('afterend',scroll);}
  }

  function ensureBelow(tools){if(!document.getElementById('rk-search-v5-below')) tools.insertAdjacentElement('afterend',createBelow());}

  function apply(){
    var search=document.getElementById('rk-herosearch'),tools=document.getElementById('rk-tools'),topbar=document.getElementById('rk-topbar');if(!search||!tools||!topbar) return false;
    document.body.classList.remove('rk-home-v2','rk-search-home','rk-search-v3','rk-search-v4');document.body.classList.add('rk-search-v5');addStyles();installActions();
    var landing=topbar.parentElement;if(landing&&landing.classList.contains('rk-flat')) landing.classList.remove('rk-flat');
    ensureNav(topbar);ensureHero(search,tools);ensureBelow(tools);return true;
  }
