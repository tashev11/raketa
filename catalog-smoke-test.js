...
load('document-base-extra-3.js');
load('document-base-contracts-2.js');
load('document-base-corporate-it.js');
load('document-base-commerce-claims.js');
load('document-taxonomy-sync.js');
